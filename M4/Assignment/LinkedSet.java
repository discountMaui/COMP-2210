...
public class LinkedSet<T extends Comparable<? super T>> implements Set<T> {
   ...
   public boolean add(T element) {
      ...
      if (element == null || contains(element)) { // checks if element is null or list already contains element
         return false;
      }
      Node current = front;
      Node n = new Node(element);
      
      if (isEmpty()) { // if list is empty, add at front
         front = n;
         rear = n;
         rear.next = null;
         size++;
      ...
      else if (front.element.compareTo(element) > 0) { // if element is less then front, it becomes new front
         n.next = front;
         front.prev = n;
         front = n;
         size++;
      ...
      else if (element.compareTo(rear.element) > 0) { // if element is greater than rear, it becomes new rear
         rear.next = n;
         n.prev = rear;
         rear = n;
         rear.next = null;
      ...
      else {  // finds correct postion between two nodes and adds element node
